...
namespace RisingSigma.Database.Migrations
{
    ...
    [Migration("20241227231518_CreateExerciseTemplate")]
    partial class CreateExerciseTemplate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RisingSigma.Database.Entities.ExerciseTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RisingSigma.Database.Entities.MuscleGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RisingSigma.Database.Entities.Exercise", b =>
                {
                    b.HasOne("RisingSigma.Database.Entities.ExerciseTemplate", "ExerciseTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("RisingSigma.Database.Entities.ExerciseTemplate", b =>
                {
                    b.HasOne("RisingSigma.Database.Entities.MuscleGroup", "MuscleGroup")
                        .WithMany()
